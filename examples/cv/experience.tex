  ...
  \cventry
    ...
    {July 2021 to present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Grai is a platform agnostic marketplace for ML and analytics applications.}
        \item {Gain access to the universe of AI without having to build a team from scratch.}
      \end{cvitems}
    }
